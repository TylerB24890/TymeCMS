...
/**
 * 
 * @desc    This script provides helper functions for the custom CMS
 * 
 * @author  Tyler Bailey
 * 
 */
...
//generate single article link
function article_link($article){
	return 'article/' . intval($article->id) . '/' . e($article->slug);
}

//generate list of links to articles
...
//truncate blog posts for excerpts
...
//create htmlentitites for tinyMCE
function e($string){
